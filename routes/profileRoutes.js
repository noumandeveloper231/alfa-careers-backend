...
import {
  recordProfileView,
  getProfileViews,
  getProfileViewsForPeriod,
} from "../controllers/profileViewController.js";
...
// Get list of profile views for a user/employee (auth id)
router.get("/:id/views", getProfileViews);

// Get profile views data for a user/employee (auth id) across 7, 15 and 30 days
