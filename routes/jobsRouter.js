...
import { addJob, getAllJobs, getApprovedJobs, getCategoryJobs, getCompanyJobs, getCompanyJobsById, getJob, getJobBySlug, getModifiedJobs, getPendingJobs, getSavedJobs, getSponsoredJobs, removeJob, searchJob, updateJob, updateJobStatus } from '../controllers/jobsController.js'
...
jobsRouter.get('/getmodifiedjobs', getModifiedJobs);
